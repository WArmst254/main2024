  ...
  public static Command intakeShootAuto() {
    ...
    return (
      Commands.run(() -> {
        ...
        .until(shooter::shooterSensorOut)); //cancel the command when the shooter sensor is triggered
  }
  ...
  public static Command outakeShootAuto() {
    ...
    return (
      Commands.run(() -> {
        ...
        .until(intake::invIntakeSensorOut)); //cancel the command when the intake sensor is no longer triggered
          }
