...
import frc.robot.util.SwerveMath;
...
public class DriveSubsystem extends SubsystemBase{
    ...
    public void set(ChassisSpeeds chassisSpeeds) {
        ...
        if(fieldCentric) {
            ...
            else omega = Math.abs(lastJoystickAngle - getYaw().getRadians()) < (2*Math.PI)/10 &&
    ...
    public void setStates(SwerveModuleState[] states) {
        for(int i = 0; i < modules.length; i++) {
            ...
            Logger.recordOutput("Velocity/Mod"+i+"Angle", NRUnits.logConstrainRad(states[i].angle.getRadians()+(2*Math.PI)));
    ...
    public void setState(int modIndex, SwerveModuleState state) {
        ...
        Logger.recordOutput("Velocity/Mod"+modIndex+"Angle", NRUnits.logConstrainRad(state.angle.getRadians()+(2*Math.PI)));
        modules[modIndex].set(state);
    }
    ...
    public void zeroAngle() {
        ...
        Rotation2d.fromRadians((2*Math.PI)/2));
    }
